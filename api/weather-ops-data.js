...
function normalizePayload(payload, source) {
  ...
  return {
    ...
    opsActionsProvided: Array.isArray(data.opsActions || data.ops_actions || data.operationsActions || data.operations_actions),
    marketingActionsProvided: Array.isArray(data.marketingActions || data.marketing_actions || data.crmActions || data.crm_actions),
    recoveryProvided: Boolean(data.recovery && typeof data.recovery === 'object'),
